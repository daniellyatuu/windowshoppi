...
class FollowingPostExplore extends StatefulWidget {
  final int index;
  final int accountId;
  FollowingPostExplore({@required this.index, @required this.accountId})
      : super();

  @override
  _FollowingPostExploreState createState() => _FollowingPostExploreState();
}

class _FollowingPostExploreState extends State<FollowingPostExplore> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<FollowingPostBloc, FollowingPostStates>(
