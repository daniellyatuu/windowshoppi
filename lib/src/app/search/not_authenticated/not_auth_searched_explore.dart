...
class NotAuthSearchedExplore extends StatefulWidget {
  final int index;
  NotAuthSearchedExplore({@required this.index}) : super();

  @override
  _NotAuthSearchedExploreState createState() => _NotAuthSearchedExploreState();
}

class _NotAuthSearchedExploreState extends State<NotAuthSearchedExplore> {
  ...
  void _onScroll() {
    ...
    if (_scrollThresholdIndex >= maxScrollIndex - currentScrollIndex) {
      ...
      if (maxScrollIndex >= _limit) {
        ...
        print('not auth search load more');
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<SearchPostBloc, SearchPostStates>(
