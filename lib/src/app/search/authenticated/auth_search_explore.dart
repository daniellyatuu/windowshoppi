...
class AuthSearchedExplore extends StatefulWidget {
  final int index;
  AuthSearchedExplore({@required this.index}) : super();

  @override
  _AuthSearchedExploreState createState() => _AuthSearchedExploreState();
}

class _AuthSearchedExploreState extends State<AuthSearchedExplore> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<AuthenticationBloc, AuthenticationStates>(
        builder: (context, authState) {
          if (authState is IsAuthenticated) {
            return BlocBuilder<AuthSearchPostBloc, AuthSearchPostStates>(
              builder: (context, state) {
                if (state is AuthSearchPostSuccess) {
